...
class SWP_Meta_Box_Loader {
	...
	public function load_meta_boxes( $meta_boxes ) {
        ...
        $open_graph_image = array(
            ...
            'type'  => 'image_advanced',
            'clone' => false,
            'class' => $prefix . 'small_image open-graph',
            'max_file_uploads' => 1,
        );
        ...
        $open_graph_title = array(
            ...
            'id'    => $prefix . 'og_title',
            'type'  => 'textarea',
            'class' => $prefix . 'og_title open-graph',
            'clone' => false,
        );
        ...
        $open_graph_description = array(
            ...
            'class' => $prefix . 'og_description open-graph',
            'type'  => 'textarea',
            'clone' => false,
        );
        ...
        $twitter_image = array(
            ...
            'type'  => 'image_advanced',
            'clone' => false,
            'class' => $prefix . 'small_image twitter',
            'max_file_uploads' => 1,
        );
        ...
        $twitter_description = array(
            ...
            'class' => $prefix . 'twitter_card_description twitter',
            'type'  => 'textarea',
            'clone' => false,
        );
        ...
        $custom_tweet = array(
            ...
            'class' => $prefix . 'custom_tweetWrapper twitter',
            'type'  => 'textarea',
            'clone' => false,
        );
        ...
        $pinterest_description = array(
            ...
            'class' => $prefix . 'pinterest_descriptionWrapper pinterest',
            'type'  => 'textarea',
            'clone' => false,
        );
