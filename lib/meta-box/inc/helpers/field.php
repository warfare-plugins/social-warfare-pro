...
class SWPMB_Helpers_Field {
	...
	public static function get_class( $field ) : string {
		...
		$class = 'SWPMB_' . SWPMB_Helpers_String::title_case( $type ) . '_Field';
		$class = apply_filters( 'swpmb_field_class', $class, $type );
		return class_exists( $class ) ? $class : 'SWPMB_Input_Field';
	}
