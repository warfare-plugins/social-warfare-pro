...
class SWPMB_Meta_Box_Registry {
	 ...
	 * @return \SWPMB_Meta_Box
	 */
	public function make( $settings ) {
		$class_name = apply_filters( 'swpmb_meta_box_class_name', 'SWPMB_Meta_Box', $settings );
	 ...
	 *
	 * @param SWPMB_Meta_Box $meta_box Meta box instance.
	 */
	public function add( SWPMB_Meta_Box $meta_box ) {
	 ...
	 *
	 * @return SWPMB_Meta_Box|bool False or meta box object.
	 */
