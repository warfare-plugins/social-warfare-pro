...
class SWPMB_Core {
	...
	public function init() {
		load_plugin_textdomain( 'meta-box', false, plugin_basename( SWPMB_DIR ) . '/languages/' );
	...
	public function register_meta_boxes() {
		$configs  = apply_filters( 'swpmb_meta_boxes', array() );
		$registry = swpmb_get_registry( 'meta_box' );
