...
class SWPMB_OSM_Field extends SWPMB_Field {
	...
	public static function html( $meta, $field ) {
		...
		$html    = sprintf(
			'<div class="swpmb-osm-field" data-address-field="%s">',
			esc_attr( $address )
		);
	...
	private static function enqueue_map_assets() {
		wp_enqueue_style( 'leaflet', SWPMB_JS_URL . 'leaflet/leaflet.css', [], '1.9.4' );
		wp_enqueue_script( 'leaflet', SWPMB_JS_URL . 'leaflet/leaflet.js', [], '1.9.4', true );
	}
}
