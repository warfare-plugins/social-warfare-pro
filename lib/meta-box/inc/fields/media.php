...
class SWPMB_Media_Field extends SWPMB_File_Field {
	...
	public static function admin_enqueue_scripts() {
		...
		wp_enqueue_script( 'swpmb-media', SWPMB_JS_URL . 'media.js', array( 'jquery-ui-sortable', 'underscore', 'backbone', 'media-grid' ), SWPMB_VER, true );
	...
	public static function add_actions() {
		$args  = func_get_args();
		$field = reset( $args );
		add_action( 'print_media_templates', array( SWPMB_Helpers_Field::get_class( $field ), 'print_templates' ) );
	}
	...
	public static function value( $new, $old, $post_id, $field ) {
		$new = SWPMB_Helpers_Array::from_csv( $new );
