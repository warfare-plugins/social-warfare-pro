...
class SWPMB_User_Field extends SWPMB_Object_Choice_Field {
	public static function add_actions() {
		add_action( 'wp_ajax_swpmb_get_users', [ __CLASS__, 'ajax_get_users' ] );
		add_action( 'wp_ajax_nopriv_swpmb_get_users', [ __CLASS__, 'ajax_get_users' ] );
	...
	public static function ajax_get_users() {
		...
		$items = apply_filters( 'swpmb_ajax_get_users', $items, $field, $request );
	...
	public static function add_new_form( array $field ): string {
		...
		return sprintf(
			'<a href="#" class="swpmb-user-add-button swpmb-modal-add-button" data-url="%s">%s</a>',
