...
class SWPMB_Taxonomy_Field extends SWPMB_Object_Choice_Field {
	...
	public static function add_actions() {
		add_action( 'wp_ajax_swpmb_get_terms', array( __CLASS__, 'ajax_get_terms' ) );
		add_action( 'wp_ajax_nopriv_swpmb_get_terms', array( __CLASS__, 'ajax_get_terms' ) );
	}
	...
	public static function add_new_form( $field ) {
		...
		$html = '
		<div class="swpmb-taxonomy-add">
			<button class="swpmb-taxonomy-add-button">%s</button>
			<div class="swpmb-taxonomy-add-form swpmb-hidden">
	...
	public static function admin_enqueue_scripts() {
		...
		wp_enqueue_style( 'swpmb-taxonomy', SWPMB_CSS_URL . 'taxonomy.css', array(), SWPMB_VER );
		wp_enqueue_script( 'swpmb-taxonomy', SWPMB_JS_URL . 'taxonomy.js', array( 'jquery' ), SWPMB_VER, true );
