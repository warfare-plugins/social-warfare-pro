...
class SWPMB_Datetime_Field extends SWPMB_Text_Field {
	...
	public static function admin_register_scripts() {
		...
		wp_register_style( 'swpmb-date', SWPMB_CSS_URL . 'date.css', array( 'jquery-ui-datepicker' ), '1.8.17' );

		wp_register_style( 'jquery-ui-slider', "$url/jquery.ui.slider.css", array( 'jquery-ui-core', 'jquery-ui-theme' ), '1.8.17' );
		wp_register_style( 'jquery-ui-timepicker', "$url/jquery-ui-timepicker-addon.min.css", array( 'swpmb-date', 'jquery-ui-slider' ), '1.5.0' );
		...
		wp_register_script( 'swpmb-datetime', SWPMB_JS_URL . 'datetime.js', array( 'jquery-ui-datepicker', 'jquery-ui-timepicker-i18n', 'underscore' ), SWPMB_VER, true );
		wp_register_script( 'swpmb-date', SWPMB_JS_URL . 'date.js', array( 'jquery-ui-datepicker', 'underscore' ), SWPMB_VER, true );
	...
	public static function meta( $post_id, $saved, $field ) {
		...
		if ( $field['timestamp'] ) {
			return SWPMB_Helpers_Array::map( $meta, __CLASS__ . '::from_timestamp', $field );
		}

		if ( $field['save_format'] && $meta ) {
			return SWPMB_Helpers_Array::map( $meta, __CLASS__ . '::from_save_format', $field );
		}
