 ...
 */
class SWPMB_Datetime_Field extends SWPMB_Input_Field {
	/**
	...
	public static function register_assets() {
		...
		wp_style_add_data( 'jquery-ui-datepicker', 'path', SWPMB_CSS_DIR . 'jqueryui/datepicker.css' );
		...
		wp_register_style( 'jquery-ui-timepicker', "$url/jquery-ui-timepicker-addon.min.css", [ 'swpmb-date', 'jquery-ui-slider' ], '1.6.3' );
		wp_style_add_data( 'jquery-ui-timepicker', 'path', SWPMB_CSS_DIR . 'jqueryui/jquery-ui-timepicker-addon.min.css' );

		wp_register_style( 'swpmb-date', SWPMB_CSS_URL . 'date.css', [ 'jquery-ui-datepicker' ], SWPMB_VER );
		wp_style_add_data( 'swpmb-date', 'path', SWPMB_CSS_DIR . 'date.css' );
		...
		wp_register_script( 'swpmb-datetime', SWPMB_JS_URL . 'datetime.js', [ 'jquery-ui-datepicker', 'jquery-ui-timepicker-i18n', 'underscore', 'jquery-ui-button', 'jquery-ui-timepicker-slider', 'swpmb' ], SWPMB_VER, true );
		wp_register_script( 'swpmb-date', SWPMB_JS_URL . 'date.js', [ 'jquery-ui-datepicker', 'underscore', 'swpmb' ], SWPMB_VER, true );
		wp_register_script( 'swpmb-time', SWPMB_JS_URL . 'time.js', [ 'jquery-ui-timepicker-i18n', 'jquery-ui-button', 'jquery-ui-timepicker-slider', 'swpmb' ], SWPMB_VER, true );
		...
		foreach ( $handles as $handle ) {
			SWPMB_Helpers_Field::localize_script_once( "swpmb-$handle", 'SWPMB_' . ucfirst( $handle ), $data );
		}
	}
