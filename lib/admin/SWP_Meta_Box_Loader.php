...
class SWP_Meta_Box_Loader {
	...
	public function load_meta_boxes( $meta_boxes ) {
        ...
        $custom_tweet = array(
            ...
            'placeholder' => 'If left empty, defaults to your content in Open Graph Title and this appened to the end: ' . the_permalink() . " " .  $twitter_handle ,
            'desc'  => ( $twitter_id
        ...
        $pinterest_image = array(
            ...
            'class' => $prefix . 'pinterest_imageWrapper '. $prefix . 'large_image pinterest swpmb-left',
            'type'  => 'image_advanced',
            'clone' => false,
            'max_file_uploads' => 1,
        );
