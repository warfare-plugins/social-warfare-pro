...
function swp_output_custom_color( $info ) {
	...
	if ( $swp_user_options['default_colors'] == 'custom_color_outlines' || $swp_user_options['single_colors'] == 'custom_color_outlines' || $swp_user_options['hover_colors'] == 'custom_color_outlines' ) :
		$info['html_output'] .= PHP_EOL . '<style type="text/css">.swp_social_panel.swp_d_custom_color_outlines a, html body .swp_social_panel.swp_i_custom_color_outlines .nc_tweetContainer:hover a, body .swp_social_panel.swp_o_custom_color_outlines:hover a { color:' . $swp_user_options['customColor'] . '; }
.swp_social_panel.swp_d_custom_color_outlines .nc_tweetContainer, html body .swp_social_panel.swp_i_custom_color_outlines .nc_tweetContainer:hover, body .swp_social_panel.swp_o_custom_color_outlines:hover .nc_tweetContainer { background:transparent; border:1px solid ' . $swp_user_options['customColor'] . '; } </style>';
