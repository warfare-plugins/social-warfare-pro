        ...
        if ( $this->options['float_default_colors'] == 'float_custom_color'
    		...
    		$info['html_output'] .= PHP_EOL .
                '<style type="text/css">
                    ...
                    .swp_social_panelSide.swp_default_custom_color a, html body .swp_social_panel.swp_individual_custom_color .nc_tweetContainer:hover a, body .swp_social_panel.swp_other_custom_color:hover a {color:white} .swp_social_panel.swp_default_custom_color .nc_tweetContainer, html body .swp_social_panel.swp_individual_custom_color .nc_tweetContainer:hover, body .swp_social_panel.swp_other_custom_color:hover .nc_tweetContainer { background-color:' . $this->options['float_custom_color'] . '!Important; border:1px solid ' . $this->options['float_custom_color'] . '!Important;} </style>';
    	endif;
