 ...
 * Pocket
 *
 * Class to add a Pocket share button to the available buttons
 *
 ...
 *
 */
class SWP_Pocket extends SWP_Social_Network {
	...
	public function __construct() {
		...
		$this->default        = false;
        $this->premium        = 'pro';
		$this->base_share_url = 'https://getpocket.com/save?url=';
	 ...
	 *
	 */
	public function get_api_link( $url = null) {
		return 0;
	}
	 ...
	 *
	 */
	public function parse_api_response( $response = null ) {
		return 0;
