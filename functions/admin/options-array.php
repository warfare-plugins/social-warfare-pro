 ...
 */
function swp_pro_options_display($swp_options) {
 ...
 * @return 	array $swp_options The modified array of options
 */
function swp_pro_options_styles($swp_options) {
...
function swp_pro_options_social_identity($swp_options) {
...
function swp_pro_options_advanced($swp_options) {
...
remove_filter('swp_options', 'swp_options_display'              , 1 );
remove_filter('swp_options', 'swp_options_styles'               , 2 );
remove_filter('swp_options', 'swp_options_social_identity'      , 3 );
remove_filter('swp_options', 'swp_options_advanced'             , 4 );
add_filter('swp_options', 'swp_pro_options_display'             , 5 );
